...
CREATE TABLE IF NOT EXISTS `Team10`.`Exhibit` (
  ...
  INDEX `fk_EXHIBIT_Department1_idx` (`Department_ID` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `Team10`.`Animal` (
  ...
  INDEX `fk_Animal_Exhibit1_idx` (`Exhibit_ID` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `Team10`.`Gift_Shop` (
  ...
  PRIMARY KEY (`Shop_ID`),
  INDEX `fk_Shop_Department1_idx` (`Department_ID` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `Team10`.`Event` (
  ...
  INDEX `fk_Public Events_Department1_idx` (`Department_ID` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `Team10`.`Private_Event` (
  ...
  INDEX `fk_Private Events_Department1_idx` (`Department_ID` ASC) VISIBLE,
  CONSTRAINT `Department_ID`
    FOREIGN KEY (`Department_ID`)
    REFERENCES `Team10`.`Department` (`Department_ID`)
    ON DELETE NO ACTION
